...
const additionalServices = [
  ...
  "GPS Tracking Server Integration",
      ...
      sections={[
        {
          ...
          items: [
            { icon: Rocket, title: "ERP Implementation", href: "/platform", linkLabel: "Cloud ERP →", text: "Deploy FleetArabia with industry best practices, tailored configurations, data migration, user training and go-live support." },
            ...
            { icon: Link2, title: "System Integration", href: "/integrations", linkLabel: "Integrations →", text: "Connect FleetArabia to Salik, traffic-fine, parking and fuel-card data, a GPS tracking server and other systems through its REST APIs." },
            ...
            { icon: Smartphone, title: "Mobile Application Development", text: "Develop mobile applications for customers, drivers, field staff, workshop technicians and management." },
            { icon: Database, title: "Data Migration", href: "/platform", linkLabel: "Cloud ERP →", text: "Migrate customers, vehicles, contracts, financial data, operational history and master records securely with minimal business disruption." },
