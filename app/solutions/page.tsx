      ...
      sections={[
        {
          ...
          items: [
            ...
            { icon: MODULE_ICONS["Chauffeur & Transport"], title: "Chauffeur & Transport", text: "Take transport inquiries, send quotations, book and dispatch trips to drivers, and bill per trip, hour, day or kilometer." },
            { icon: MODULE_ICONS["Bus Transportation"], title: "Bus Transportation", text: "Plan routes and school-run schedules, generate trips, assign drivers and vehicles, record driver attendance and bill transport contracts." },
            { icon: MODULE_ICONS["Workshop Management"], title: "Workshop Management", text: "Run the workshop from service booking and vehicle receipt to inspection, estimate and approval, job card, parts and labor, quality check and road test, release and invoice." },
            ...
            { icon: MODULE_ICONS["Billing & Revenue Management"], title: "Billing & Revenue Management", text: "Generate rental, lease, toll and transport invoices in bulk, apply UAE VAT, issue credit notes and customer statements, and record receipts." },
            { icon: MODULE_ICONS["Fuel Management"], title: "Fuel Management", text: "Import ENOC and ADNOC fuel-card statements and review fuel spend by vehicle, card and station." },
            { icon: MODULE_ICONS["Driver Management"], title: "Driver Management", text: "Driver profiles, licenses and documents with expiry tracking, assignments, incidents, attendance and compliance checks." },
            ...
            { icon: MODULE_ICONS["Finance & Integrations"], title: "Finance & Integrations", text: "Ledger, journals, trial balance and UAE VAT, plus imports for Salik, fines, parking and fuel-card statements." },
          ],
        },
        {
