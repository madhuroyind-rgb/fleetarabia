      ...
      sections={[
        {
          ...
          items: [
            { icon: Car, title: "Vehicle Rental Companies", href: "/solutions/car-rental-software", linkLabel: "Car Rental Software →", text: "Manage reservations, quotations, agreements, fleet allocation, pricing, billing, vehicle returns, replacements, toll and traffic fine charges, and customer service from one integrated platform." },
            { icon: KeyRound, title: "Leasing Companies", href: "/solutions/fleet-leasing", linkLabel: "Fleet Leasing →", text: "Digitize the complete lease lifecycle with contract management, corporate billing, renewals, vehicle replacement, maintenance planning and financial integration." },
            { icon: CarTaxiFront, title: "Chauffeur Services", href: "/solutions/chauffeur-transport", linkLabel: "Chauffeur & Transport →", text: "Take transport inquiries, send quotations, book and dispatch trips to drivers, and bill per trip, hour, day or kilometer." },
            { icon: Bus, title: "Bus & School Transport", href: "/solutions/chauffeur-transport", linkLabel: "Chauffeur & Transport →", text: "Plan routes and school-run schedules, generate trips, assign drivers and vehicles, record driver attendance and bill transport contracts." },
            { icon: Briefcase, title: "Corporate Fleet Management", href: "/solutions/fleet-management", linkLabel: "Fleet Management →", text: "Run company-owned fleets: vehicle register and movements, driver records and compliance, workshop jobs, fuel-card statement imports and reports by company and branch." },
            { icon: Wrench, title: "Workshops", href: "/solutions/workshop-management", linkLabel: "Workshop Management →", text: "Run the workshop from service booking and vehicle receipt to inspection, estimate and approval, job card, parts and labor, quality check and road test, release and invoice." },
            { icon: Landmark, title: "Government & Public Sector", href: "/solutions/fleet-management", linkLabel: "Fleet Management →", text: "Role-based access, approvals and a full audit trail for public-sector fleets." },
            { icon: Building2, title: "Enterprise Mobility Groups", href: "/platform", linkLabel: "Cloud ERP Platform →", text: "Operate multiple companies, brands, branches and business units on a single platform with centralized finance, standardized processes and enterprise reporting." },
          ],
        },
        {
