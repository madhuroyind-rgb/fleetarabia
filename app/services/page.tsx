      ...
      sections={[
        {
          ...
          items: [
            ...
            { icon: Link2, title: "System Integration", text: "Connect FleetArabia to Salik, traffic-fine, parking and fuel-card data, a GPS tracking server and other systems through its REST APIs." },
